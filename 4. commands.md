...
grep ERROR practice_logs.txt | grep database # Find lines containing both ERROR and database
grep ^2026 practice_logs.txt # Find lines that start with date 2026-02-25
grep successfully$ practice_logs.txt # Find lines ending with "successfully"
grep username practice_logs.txt # Find usernames
grep -E "ERROR|WARNING" practice_logs.txt # Match lines containing ERROR OR WARNING
